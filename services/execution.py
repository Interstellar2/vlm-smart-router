"""
质量升档与元数据合并封装 + Fallback Session（支持 sticky 降级的模型调用会话）
合并自 fallback/escalation.py 和 fallback/session.py
"""
...
from core.settings import fallback_config, routing_config
